...
export default function CreateAudioWillScreen() {
  ...
  const handleStopAndSave = async () => {
    ...
    try {
      ...
      // We have a completed recording blob; allow continuing even if upload fails.
      setIsSaved(true);
      ...
      console.error(e);
      setUploadError('Audio recorded, but upload failed. You can still continue to Assets.');
    } finally {
      setIsSaving(false);
    }
  };
